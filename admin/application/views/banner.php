   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="row" style="background:white;padding:20px;box-shadow:0px 0px 9px silver">
             ...
             <h4>ADD IMAGE   <span style="color:red;"><small>( Size 710x372)</small></span></h4>
                <form method="post" action="<?= base_url('index.php/Admin_controller/insert_add_banner') ?>" enctype='multipart/form-data' class="form-group">
                  <div class="row">
                    <div class="col-md-12">
                                ...
                                <tbody>
                                 <thead>
                                  ...
                                  <?php foreach($banner as $res):?>
                                    <tr>
                                       <td><img src="<?php echo base_url(); ?><?php echo $res->image ?>" alt="" width="100px"></td>
                                      
                                       <td><a href="<?= base_url("index.php/Admin_controller/del_banner/$res->id")?>">Delete</a></td>
                                    </tr>
                                 <?php endforeach; ?>
...
$(this).next().trigger('click');
   ...
   <?php
      if($this->session->flashdata('banner_alt'))
     {
      ?>
      <script>
               swal("Banner Successfilly Submitted","", "success");
      </script>
      <?php }?>
   ...
   <?php
      if($this->session->flashdata('wrong_format'))
     {
      ...
      <?php }?>
       ...
       <?php
      if($this->session->flashdata('dlt_banner_alt'))
     {
      ?>
      <script>
               swal("Banner Delete Successfilly","", "success");
      </script>
      <?php }?>
</body>
