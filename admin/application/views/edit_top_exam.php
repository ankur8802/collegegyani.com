   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="news-section">
            <form  action='<?= base_url("index.php/Admin_controller/updateexams/$exams->id")?>'  method="post" enctype='multipart/form-data'>
