  ...
  <div id="wrapper">
   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 style="font-size:18px;">View Users Application</h1>
          <div class="row" style="background:white;padding:20px;box-shadow:0px 0px 9px silver">
              <div class="col-md-12">
                    <div class="table-responsive">
                   
                              <table id="dataTableExample1" class="table table-bordered table-hover text-center" width="100%;">
                                 ...
                                 <thead>
                                  ...
                                  <?php
                                    $i=1;
                                   foreach($examapplicationdetail as $res)
                                  {
...
<?php include('table2excel.php')?>
 <script type="text/javascript">
  ...
  $("#dataTableExample1").table2excel({
    ...
    exclude: ".noExl",
    name: "Application",
    filename: "Exam Application", //do not include extension
