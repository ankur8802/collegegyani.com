  ...
  <div id="wrapper">
   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 style="font-size:18px;">Students Helpdesk</h1>
...
<?php include('table2excel.php')?>
 <script type="text/javascript">
  ...
  $("#dataTableExample1").table2excel({
    ...
    exclude: ".noExl",
    name: "Application",
    filename: "Student Helpdesk Application", //do not include extension
