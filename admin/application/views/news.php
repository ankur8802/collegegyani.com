   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="news-section">
            ...
            <form  action="<?= base_url('index.php/Admin_controller/insertnews')?>"  method="post" enctype='multipart/form-data'>
              <ul class="form-group row">
                ...
                <li class="col-md-6">
                  ...
                  <textarea type="text" name="disc" class="form-control" required maxlength="600" rows="12"></textarea> 
                </li>
                 <li class="col-md-6">
