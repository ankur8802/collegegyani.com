                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr class="text-center" style="align-items: center;justify-content: center;">
                                        ...
                                        <td>
                                        <button type="button" class="btn btn-primary"><a href="<?= base_url("index.php/Admin_controller/reviewapproved/$key->id")?>" style="color:#fff;">Approve</a></button>
                                        <br><br>
                                        <button type="button" class="btn btn-danger"><a href="<?= base_url("index.php/Admin_controller/reviewdelete/$key->id")?>" style="color:#fff;">Reject</a></button>
                                        </td>
...
<?php include('table2excel.php')?>
 <script type="text/javascript">
  ...
  $("#dataTableExample1").table2excel({
    ...
    exclude: ".noExl",
    name: "Application",
    filename: "Reviews", //do not include extension
