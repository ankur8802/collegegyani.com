   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="news-section">
            <form  action="<?= base_url('index.php/Admin_controller/insertexams')?>"  method="post" enctype='multipart/form-data'>
              <ul class="form-group row">
                 <li class="col-md-6">
                  <label style="margin-top: 10px;">Select Exam Type</label>
                ...
                <li class="col-md-6">
                  <label style="margin-top: 10px;">Exam Title</label>
                  <input type="text" name="title" class="form-control" placeholder="Enter Exam Title ........" required maxlength="30">
                </li>

                  <li class="col-md-6">
                  <label style="margin-top: 10px;">Result Link <span style="color:red;"> (Optional)</span> </label>
                  <input type="text" name="link" class="form-control" placeholder="Enter Exam Title ........" required maxlength="30">
                </li>
                ...
                <li class="col-md-6">
                  <label style="margin-top: 10px;">Logo <span style="color:red;"> (Optional)</span> </label>
                  <input type="file" name="logo" class="form-control">
                </li>

                 <li class="col-md-6">
                  <label style="margin-top: 10px;">Exam Position<span style="color:red;"> (Optional)</span></label>
                   <select class="form-control" name="Position">
                    <option value="">Choose Exam Position</option>
                     <option>Top</option>
                ...
                <li class="col-md-6">
                  <label style="margin-top: 10px;">Short Description<span style="color:red;"> (Under 200 Words)</span></label>
                 <textarea  class="description form-control" name="short_desc" placeholder="Enter Short Description ........" rows="10" maxlength="200"></textarea>
                </li>
