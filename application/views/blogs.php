...
<div class="inner-wrap listing" style="background-color:#f3f3f3;" >
  <div class="container-fluid">
    ...
    <div class="col-md-3 col-sm-4 col-6 text-center">
      <a href="<?= base_url("blog/".str_replace(" ","-", $blogdata->title))?>">
      <div class="inner-popular">
        <img src="<?= base_url()?>/uploads/blog/<?= $blogdata->image?>" alt="Blog Image" style="height:200px;">
         <h5 style="padding:5px;"> <!-- <?= $blogdata->title?> -->
           <?php
                 $string = word_limiter($blogdata->title,5);
                  echo $string;
           ?>
         </h5>
      </div>
