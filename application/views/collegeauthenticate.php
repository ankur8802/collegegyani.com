...
<!-- <td><img src="<?php echo base_url(); ?>../college/upload/<?php echo $r->image ?>" alt="" width="100px"></td> -->
...
<td><?php echo $r->position ?></td>
 ...
 <!--  <td>
   ...
   <td>
    <a href="<?= base_url("index.php/Admin_controller/edit/{$r->id}")?>" ><button>Edit</button></a>   
   </td>

   <td>
      <select class="topcollege">
        ...
        <a class="normal" href="<?= base_url("index.php/Admin_controller/positionnormal/{$r->id}")?>" class="btn btn-success normalbtn" style="color:#fff;display: none; ">Normal</a>
       <a class="top"  href="<?= base_url("index.php/Admin_controller/positiontop/{$r->id}")?>" class="btn btn-success topbtn" style="color:#fff; display: none;">Top</a>
