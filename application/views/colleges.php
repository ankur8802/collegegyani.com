...
<!--inner heading start-->
<div class="inner-heading pd-10">
  <div class="container-fluid text-center">
   <!--  <h1>Collegegyani.com</h1> -->
  <a href="https://www.collegegyani.com/index.php/User/landing/jaipuria-institute-of-management" target="_blank"> <img src="<?=base_url()?>assets/images/add.png" alt="lead"> </a>
  </div>
</div> 
<!--inner heading end--> 
 ...
 -->        <!--   <div class="sidebarpad">
      ...
      <div class="col-md-12 col-sm-12">
        ...
        <ul class="listService"> 
          ...
          foreach ($data as $key) {
            ?>
          <li class="col-md-3"style="padding: 5px!important;"  >
        ...
        <div class="feature-image" style="height:160px;background:linear-gradient( rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('<?php echo base_url("upload/". $key->image)?>');background-size:cover; ">
          ...
          <div class="flex" style="display: flex;">
            ...
            <div class="flex-con" style="flex-basis:90%;">
                 ...
                 <h3 style="display: inline;" class="fz-14 mg-5"><?= $key->college_name?> (<?= $key->college_name_short?>)</h3>
               </a>
        ...
        <div class="" style="border-top: 1px solid #e6e6e6">
         ...
         <?php 
         $college_email_store=$key->college_email;
        ...
        <div class="college-detail-info-btn">
          ...
          <?php
                $college_email_brochure=$key->college_email;
    ...
    <div class="row">
      <div class="col-md-12 text-center" style="padding:1em;">
        <a href="https://www.collegegyani.com/index.php/User/landing/jaipuria-institute-of-management" target="_blank"><img src="<?= base_url()?>/assets/images/add.png" alt=""></a>
      </div>
    </div>
     <div class="row">
