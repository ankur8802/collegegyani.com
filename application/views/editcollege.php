...
<form action="<?= base_url('index.php/Admin_controller/updatecollegedetail')?>"method="post" enctype="multipart/form-data">
  <div class="row form-group">
  <div class="col-md-6 form-group"><label  class=" form-control-label">College Name</label>
    <input type="hidden" name="id"  value="<?= $data->id?>" class="form-control">

    <input type="text" name="college_name" id="company" value="<?= $data->college_name?>" class="form-control"></div>
                ...
                <input type="email" required=""  value="<?= $data->college_email?>" class="form-control" readonly=""
                >
              </div>
              <div class="col-md-6 form-group"><label  class=" form-control-label">College Password</label>
               ...
               <div class="col-md-6 form-group"><label  class=" form-control-label">College Phone No.</label>
                <input pattern="[6-9]{1}[0-9]{9}" type="text" required="" name="phone" id="txtPhoneNo" onkeypress="return isNumber(event)" value="<?= $data->phone?>" class="form-control" maxlength="10" type="text">
              </div>
          
              
               <div class="col-md-12 input-wrap"><label  class=" form-control-label">College Address </label>
                <textarea required="" name="address" value="" class="form-control"><?= $data->address?></textarea>
              </div>
              ...
              <div class="col-md-12 form-group"> <label  class=" form-control-label">College Description</label>
                <textarea required="" name="description" value="" class="form-control"><?= $data->description?></textarea>
              </div>
