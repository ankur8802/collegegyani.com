...
<div class="inner-heading">
  <div class="container">
    <img src="<?= base_url()?>assets/images/1.gif" alt="">
  </div>
</div> 
<!--inner heading end--> 
 ...
 -->      </div>
        ...
        <div class="feature-image" style="height:160px;background:linear-gradient( rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('<?php echo base_url("upload/". $key->image)?>');background-size:cover; ">
          ...
          <div class="flex" style="display: flex;">
            ...
            <div class="flex-con" style="flex-basis:90%;">
                   <a href="<?= base_url("college/".$key->id."/".str_replace(' ','-',$key->college_name))?>">
    ...
    <div class="row">
      <div class="col-md-12 text-center" style="padding:1em;">
        <a href="https://www.collegegyani.com/index.php/User/landing/jaipuria-institute-of-management" target="_blank"><img src="<?= base_url()?>/assets/images/add.png" alt="Add"></a>
      </div>
    </div>
     <div class="row">
