                                ...
                                <tbody>
                                 <thead>
                                    <tr class="info" style="padding:0px;background:#abc641;color:white;">
                                       ...
                                       <th style="padding:0px 10px;font-size:14px;"> College Name </th>
                                       <th style="padding:0px 10px;font-size:14px;">College Email  </th>
                                        <th style="padding:0px 10px;font-size:14px;">Course </th>
                                   
                                       <th style="padding:0px 10px;font-size:14px;">User Name  </th>
                                       <th style="padding:0px 10px;font-size:14px;">User Email </th>
                                       <th style="padding:0px 10px;font-size:14px;">User Contact no.  </th>
                                       <th style="padding:0px 10px;font-size:14px;">User City</th>
                                       <th style="padding:0px 10px;font-size:14px;">User Region</th>

                                        <th style="padding:0px 10px;font-size:14px;">Date & Time</th>
                                   
                                    </tr>
                                 </thead>

                                  <?php foreach($userapp as $res)
                                  {
                                  ...
                                  ?>
                                    <tr>
                                      ...
                                      <!--   <td>  <center> <a href="<?= base_url("index.php/Admin_controller/deleteuserapplication/$res->id")?>"> <i class="fas fa-trash-alt"></i> </a></center>   </td> -->
