   ...
   <?php include('sidebar.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="courseform"  style="background:white;padding:20px;box-shadow:0px 0px 9px silver">
            <form action="<?= base_url("index.php/College_controller/updatescholarship/$scholarshipdata->id")?>" method="post">
          
           <ul class="row">

              <li class="col-md-12 form-group">
               <label>Scholarship Detail Update</label>
               <textarea name="scholarship" required id="editor1"><?= $scholarshipdata->scholarship;?></textarea>
             </li>
