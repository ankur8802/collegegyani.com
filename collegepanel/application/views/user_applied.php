          ...
          <div class="row" style="background:white;padding:20px;box-shadow:0px 0px 9px silver">
              <div class="col-md-12">
                    <div class="table-responsive">
                            ...
                            <button class="export btn btn-success" style="margin:10px;margin-left:0;">Export Applications in Excel</button>
...
<!--                                         <th>Action</th>
 -->                                   
                               ...
                               <tbody>
                                  <?php  $i=1; foreach($userapplication as $res)
                                  {
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.js"></script>
 ...
 <script type="text/javascript">
  ...
  $("#dataTableExample1").table2excel({
    ...
    exclude: ".noExl",
    name: "Application",
    filename: "User Application", //do not include extension
